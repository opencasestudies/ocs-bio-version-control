...
In this case study, we will investigate data about samples from [this meta-analysis](https://www.tandfonline.com/doi/full/10.1080/19490976.2021.1911571) of mother and infant gut {{< glossary "microbiome">}} studies. Wang et al. identified a set of eight studies that collected mother and infant gut microbiome samples {{< glossary "longitudinal" display="longitudinally">}} and performed metagenomic sequencing. These eight studies collectively include 1,496 samples, representing 368 individuals. The variables that we will use to answer our questions include:

Variable | Details
-------- | -------
**Study** | Original study the sample comes from 
**SampleID** | ID for sample (unique ID for each combination of person and time point)
**PersonID** | ID for participant the sample came from (unique ID for each person in the study, shared across time points)
