...
Let's say that you submitted a pull request, you or your collaborator has decided that the changes look good, and you want to integrate the changes from your development branch into the base branch. This is called "merging" your pull request. This will either be easy or more complex, depending on whether there are conflicts between the two branches. 
:::{.definition_box}
::::{.definition_box_header}
Merge conflict
::::
::::{.inner_block}
When there are competing changes made to the same line of a file, or a file has been modified in one branch and deleted in another branch. 
::::
:::
...
In this pull request that you've made, you shouldn't have any merge conflicts. However, see [add link to troubleshooting section] for information about how to resolve merge conflcits. 
