...
{{< include _intro_git_github.qmd >}}
{{< include _project_organization.qmd >}}
...
{{< include _pull_requests.qmd >}}
{{< include _summary.qmd >}}
{{< include _troubleshooting.qmd >}}
...
::: {.column-margin}
to-do: link the glossary to these terms in text, so that the definitions will pop up when a learner hovers over the word with their mouse
:::
