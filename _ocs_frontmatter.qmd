...
- RStudio ([install here](https://posit.co/download/rstudio-desktop)) or Positron ([install here](https://positron.posit.co/install.html))
...
- familiarity with `dplyr` ([`dplyr` cheatsheet](https://rstudio.github.io/cheatsheets/data-transformation.pdf)) and `ggplot2` ([`ggplot2` cheatsheet](https://rstudio.github.io/cheatsheets/data-visualization.pdf)), or willingness to learn
