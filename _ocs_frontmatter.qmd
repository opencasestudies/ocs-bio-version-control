...
- OPTIONAL: command line skills (this [resource for basics with the command line](https://swcarpentry.github.io/shell-novice/key-points.html) maybe helpful)
  - this is not necessary if using GitHub Desktop, as is suggested in this case study, however there are alternate instructions throughout the case study that use the command line to interact with Git
