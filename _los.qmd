...
In this case study, we will introduce version control and describe why and how to use it to track a scientific project. We will use Git and GitHub to track an investigation of sequencing depth in a set of microbiome samples used in a meta-analysis. 
