...
```{r, fig.alt="Fork workflow, making local repo", out.width = "70%", echo = FALSE, fig.align = "center"}
...
```{r, fig.alt="Fork repo, integrating local changes to remote", out.width = "70%", echo = FALSE, fig.align = "center"}
...
:::{.column-margin}
I don't have an advanced piece of homework planned yet, but am very open to ideas for this!
:::
