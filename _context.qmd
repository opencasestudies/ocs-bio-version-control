...
Much of the gut microbiome composition is determined at birth and in early life, and the infant gut microbiome has implications for health later in life [@wang2021metagenomic]. Therefore, scientists are interested in understanding more about the factors that shape the infant gut microbiome. One question of interest is how similar the gut microbiomes are between infants and their mothers, and how this changes over time. To address this question, several studies have collected {{< glossary "longitudinal" >}} samples from infant-mother pairs. Sequencing microbiome samples is expensive, and therefore each study is limited in the number of samples they can collect. @wang2021metagenomic conducted a meta-analysis of eight of these studies, using this large data set to compare gut microbiome composition (which microbes are there?) and functional potential (what are the microbes capable of doing?) between infants and mothers.
