...
Once you add in your new line, click the green botton that says "Commit changes" and provide an informative commit message (something like "adding new line to README"). Then click the repository name in the upper left to navigate back to the home page. 
...
[Make one dropdown for installing on Mac.]

[Make one dropdown for installing on Windows.]

[Make one dropdown for installing on Linux(??).]
