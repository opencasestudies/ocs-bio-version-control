...
Next, you will open the local repository and make an update. RStudio and Positron have different approaches to opening folders. 
...
Now that we've opened our local repository and have access to the README, we will add a new line:

- click on the "README.md" file
- add a new line to the README that says "Adding a new commit locally" and save the file
