...
::: {.column-margin}
I've had a difficult time finding additional resources that describe other version control options besides Git and GitHub (outside of lists of GitHub alternatives, such as GitLab and BitBucket). I'm curious if anyone has a resource on this that they like.
:::
