...
1. For projects with large teams, it can be difficult to keep track of which contributions came from which team members. {{< glossary "Version control" >}} histories can be helpful to see who worked on each component on an analysis, in order to fairly acknowledge each contributor’s work.
