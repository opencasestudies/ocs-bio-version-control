...
Since you've performed the requested analysis, make sure to document any new files in this repository in the README.md file. After doing this, make another commit. 

::: {.panel-tabset}

#### GitHub Desktop 

Navigate back to GitHub Desktop. You should now see the modifications that you've made to "03_visualize_study_cohorts.qmd", as well as the added .png files for the figures. Add an appropriate commit message and commit. 
